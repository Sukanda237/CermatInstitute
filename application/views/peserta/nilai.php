      ...
      *********************************************************************************************************************************************************** -->
      ...
      <!-- <section id="main-content">
          ...
          <div class="alert alert-danger">
            ...
            <h3><i class="fa fa-user"></i> Nilai</h3>
                  ...
                  <div class="col-md-12">
                      <div class="content-panel fn-table">
                          <table class="table table-striped table-advance table-hover">
                            <h4><i class="fa fa-angle-right"></i> Riwayat Nilai Peserta</h4>
                            <hr>
                              <thead>
                              <tr>
                                  <th>No</th>
                                  ...
                                  <th><i class=" fa fa-search"></i> Nilai</th>
                              </tr>
                              </thead>
                              <tbody>
                              ...
                              <tr id="package1" class="accordion-toggle" data-toggle="collapse" data-parent="#OrderPackages" data-target=".tabel-01">
                                  ...
                                  <td>
                                      <button class="btn btn-primary btn-md"><i class="fa fa-search fa-2x"></i></button>
                                  </td>
                              </tr>
                                      ...
                                      <div class="accordion-body collapse tabel-01 fn-table" id="accordion1">
                                          <table class="table table-striped table-advance table-hover">
                                              ...
                                              <tr>
                                                  ...
                                                  <td>60 Menit</td>
                                                  <td>
                                                    <button class="btn btn-danger btn-md">40</button>
                                                  </td>
                                              </tr>
                                              <tr>
                                                  <td>02</td>
                                                  ...
                                                  <td>60 Menit</td>
                                                  <td>
                                                    <button class="btn btn-primary btn-md">100</button>
                                                  </td>
                                              </tr>
                                          </table>
                                      </div>
                                      ...
                                      <div class="accordion-body collapse tabel-02 fn-table" id="accordion1">
                                          <table class="table table-striped table-advance table-hover">
                                              ...
                                              <tr>
                                                  ...
                                                  <td>60 Menit</td>
                                                  <td>
                                                    <button class="btn btn-danger btn-md">30</button>
                                                  </td>
                                              </tr>
                                              <tr>
                                                  <td>02</td>
                                                  ...
                                                  <td>60 Menit</td>
                                                  <td>
                                                    <button class="btn btn-primary btn-md">80</button>
                                                  </td>
                                              </tr>
                                          </table>
                                      </div>
                                      ...
                                      <div class="accordion-body collapse tabel-03 fn-table" id="accordion1">
                                          <table class="table table-striped table-advance table-hover">
                                              ...
                                              <tr>
                                                  ...
                                                  <td>60 Menit</td>
                                                  <td>
                                                    <button class="btn btn-primary btn-md">70</button>
                                                  </td>
                                              </tr>
                                              <tr>
                                                  <td>02</td>
                                                  ...
                                                  <td>60 Menit</td>
                                                  <td>
                                                    <button class="btn btn-primary btn-md">90</button>
                                                  </td>
                                              </tr>
                                          </table>
                                      </div>
                                      ...
                                      <div class="accordion-body collapse tabel-06 fn-table" id="accordion1">
                                          <table class="table table-striped table-advance table-hover">
                                              ...
                                              <tr>
                                                  ...
                                                  <td>60 Menit</td>
                                                  <td>
                                                    <button class="btn btn-primary btn-md">60</button>
                                                  </td>
                                              </tr>
                                              <tr>
                                                  <td>02</td>
                                                  ...
                                                  <td>60 Menit</td>
                                                  <td>
                                                    <button class="btn btn-danger btn-md">55</button>
                                                  </td>
                                              </tr>
                                          </table>
                                      </div>
